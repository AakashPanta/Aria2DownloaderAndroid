...
import com.aria2.downloader.ui.permissions.PermissionAwareContent
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            Aria2DownloaderTheme(themeMode = settings.themeMode) {
                PermissionAwareContent(activity = this) {
