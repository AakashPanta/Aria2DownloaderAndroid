...
class SettingsRepository @Inject constructor(
    ...
    private fun <T : Enum<T>> enumValueOfOrNull(raw: String?, fallback: T): T {
        if (raw == null) return fallback
        return runCatching { java.lang.Enum.valueOf(fallback.declaringJavaClass, raw) }.getOrDefault(fallback)
    }
}
